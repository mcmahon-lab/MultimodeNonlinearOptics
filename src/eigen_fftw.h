  ...
  namespace internal {
    ...
    struct fftw_impl {
      ...
      inline void fwd(Complex* dst, const Complex* src, int n0, int n1=0, int n2=0) {
        getPlan(dst, src, false, n0, n1, n2).execute(fftw_cast(dst), fftw_cast(src));
      }
    ...
    protected:
      ...
      inline Plan& getPlan(void* dst, const void* src, bool inverse, int n0, int n1=0, int n2=0, bool isC2C=true) {

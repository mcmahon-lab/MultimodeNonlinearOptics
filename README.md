...
Python and C++ split step method simulation library for modeling propagation in nonlinear optical processes and for Gaussian quantum optics.

The code currently supports &#43859;&#8317;&#178;&#8318; and &#43859;&#8317;&#179;&#8318; processes, with (3+1)-dimensional propagation.
This includes dispersion/diffraction and nonlinear effects, for arbitrary pump and signal shapes.
It is straightforward to add differential equations with an arbitrary number of signal and pump modes.
...
The solvers are implemented and described in the `solvers/` directory, and registered in `solvers/RegisteredSolvers.hpp`.

There is a repository containing a collection of Jupyter notebooks that may serve as useful examples, test for correct behavior, or reproduce some published results.
...
On some systems, the compiled binary file name contains additional text, and must be renamed in order for Python to recognize the library as named.
...
plt.imshow(np.abs(gC1), origin="lower", aspect="auto")
plt.title("$|C(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
...
plt.imshow(np.abs(gS1), origin="lower", aspect="auto")
plt.title("$|S(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
plt.gca().get_xaxis().set_ticks([])
...
fig = plt.figure()
ax = fig.add_subplot(1, 2, 1)
plt.imshow(np.abs(gC2), origin="lower", aspect="auto")
plt.title("$|C(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
plt.gca().get_xaxis().set_ticks([])
...
plt.colorbar(orientation="horizontal")
ax = fig.add_subplot(1, 2, 2)
plt.imshow(np.abs(gS2), origin="lower", aspect="auto")
plt.title("$|S(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
plt.gca().get_xaxis().set_ticks([])
...
fig = plt.figure()
ax = fig.add_subplot(1, 2, 1)
plt.imshow(np.abs(gC3), origin="lower", aspect="auto")
plt.title("$|C(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
plt.gca().get_xaxis().set_ticks([])
...
plt.colorbar(orientation="horizontal")
ax = fig.add_subplot(1, 2, 2)
plt.imshow(np.abs(gS3), origin="lower", aspect="auto")
plt.title("$|S(\omega)|$")
plt.xlabel("$\omega$")
plt.ylabel("$\omega$")
plt.gca().get_xaxis().set_ticks([])

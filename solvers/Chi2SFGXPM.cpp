...
Chi2SFGXPM::Chi2SFGXPM(double relativeLength, double nlLength, double nlLengthOrig, double nlLengthChi3, double nlLengthChi3Orig,
                       ...
                       double rayleighLength, double tMax, uint tPrecision, uint zPrecision, uint ratioStepsToRecord, IntensityProfile intensityProfile, double chirp,
  ...
  _NonlinearMedium(_nSignalModes, _nDimensions, 1, true, 0, relativeLength, {nlLength, nlLengthOrig, nlLengthChi3 / 2, nlLengthChi3Orig / 2},
                   ...
                   {diffBeta0}, rayleighLength, {tMax}, {tPrecision}, zPrecision, ratioStepsToRecord, intensityProfile, chirp, delay, poling) {}
...
Chi2SFGXPM.def(
    py::init<double, double, double, double, double, double, double, double, Eigen::Ref<const Arraycd>&, _NonlinearMedium::PulseType,
             double, double, double, double, double, double, double, double, double, uint, uint, uint, _NonlinearMedium::IntensityProfile,

...
class Chi2SFGXPM : public _NonlinearMedium {
  NLM(Chi2SFGXPM, 2, 1, 0)
public:
  Chi2SFGXPM(double relativeLength, double nlLength, double nlLengthOrig, double nlLengthChi3, double nlLengthChi3Orig,
             double beta2, double beta2s, double beta2o, double beta1=0, double beta1s=0, double beta1o=0, double beta3=0,
             double beta3s=0, double beta3o=0, double diffBeta0=0, double rayleighLength=std::numeric_limits<double>::infinity(),
...
Chi2SFGXPM::Chi2SFGXPM(double relativeLength, double nlLength, double nlLengthOrig, double nlLengthChi3, double nlLengthChi3Orig,
                       double beta2, double beta2s, double beta2o, double beta1, double beta1s, double beta1o,
                       double beta3, double beta3s, double beta3o, double diffBeta0, double rayleighLength, double tMax,
  ...
  _NonlinearMedium(_nSignalModes, _nDimensions, 1, true, _nTemps, 0, relativeLength, {nlLength, nlLengthOrig, nlLengthChi3 / 2, nlLengthChi3Orig / 2},
                   {beta2}, {beta2s, beta2o}, {beta1}, {beta1s, beta1o}, {beta3}, {beta3s, beta3o},
                   {diffBeta0}, rayleighLength, {tMax}, {tPrecision}, zPrecision, ratioStepsToRecord, intensityProfile, poling) {}
...
Chi2SFGXPM.def(
    py::init<double, double, double, double, double, double, double, double, double, double, double, double, double,
             double, double, double, double, uint, uint, uint, _NonlinearMedium::IntensityProfile, Eigen::Ref<const Arrayd>&>(),

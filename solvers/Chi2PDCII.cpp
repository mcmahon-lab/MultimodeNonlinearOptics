...
Chi2PDCII::Chi2PDCII(double relativeLength, double nlLengthI, double nlLengthII,
                     ...
                     double diffBeta0, double rayleighLength, double tMax, uint tPrecision, uint zPrecision, uint ratioStepsToRecord,
...
Chi2PDCII.def(
    py::init<double, double, double, double, double, double, Eigen::Ref<const Arraycd>&, _NonlinearMedium::PulseType,
             double, double, double, double, double, double, double, double, double, uint, uint, uint,

...
public:
  Chi2AFC(double relativeLength, double nlLength, double nlLengthOrig, double beta2, double beta2s, double beta2o,
          ...
          double tMax=10, uint tPrecision=512, uint zPrecision=100, uint ratioStepsToRecord=1, IntensityProfile intensityProfile=IntensityProfile{}, double chirp=0, double delay=0);
};
...
Chi2AFC.def(
    py::init<double, double, double, double, double, double, Eigen::Ref<const Arraycd>&, _NonlinearMedium::PulseType,
             double, double, double, double, double, double, double, double, double, double, uint, uint, uint,

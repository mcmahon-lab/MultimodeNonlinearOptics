...
Chi2AFC.def(
    py::init<double, double, double, double, double, double, double, double, double, double, double, double, double,
             double, double, double, uint, uint, uint, _NonlinearMedium::IntensityProfile>(),
    "relativeLength"_a, "nlLength"_a, "nlLengthOrig"_a, "beta2"_a, "beta2s"_a, "beta2o"_a, "beta1"_a = 0, "beta1s"_a = 0,
    "beta1o"_a = 0, "beta3"_a = 0, "beta3s"_a = 0, "beta3o"_a = 0, "diffBeta0Start"_a = 0, "diffBeta0End"_a = 0,

...
Chi2PDC::Chi2PDC(double relativeLength, double nlLength, double beta2, double beta2s,
  ...
  _NonlinearMedium(_nSignalModes, _nDimensions, 1, true, _nTemps, 0, relativeLength, {nlLength}, {beta2}, {beta2s}, {beta1}, {beta1s},
...
Chi2PDC.def(
    py::init<double, double, double, double, double, double, double, double, double, double, double, uint, uint, uint,
             _NonlinearMedium::IntensityProfile, Eigen::Ref<const Arrayd>&>(),
    "relativeLength"_a, "nlLength"_a, "beta2"_a, "beta2s"_a, "beta1"_a = 0, "beta1s"_a = 0, "beta3"_a = 0, "beta3s"_a = 0,
    "diffBeta0"_a = 0, "rayleighLength"_a = infinity, "tMax"_a = 10, "tPrecision"_a = 512, "zPrecision"_a = 100,
    "ratioStepsToRecord"_a = 1, "intensityProfile"_a = _NonlinearMedium::IntensityProfile{}, "poling"_a = defArrayf);
#endif